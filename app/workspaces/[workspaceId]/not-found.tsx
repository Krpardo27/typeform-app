...
export default function WorkspaceNotFoundPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#F7F7F8] px-4 py-10">
      <section className="w-full max-w-md rounded-4xl border border-[#D1D1CD] bg-white p-8 text-center shadow-[0_18px_50px_rgba(17,24,39,0.06)]">
        ...
        <h1 className="mt-4 text-3xl font-semibold tracking-tighter text-[#111111]">
        ...
        <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            href="/workspaces/me"
            className="inline-flex items-center justify-center rounded-xl border border-[#D1D1CD] bg-[#F7F7F5] px-4 py-3 text-sm font-medium text-[#111111]/75 transition hover:border-[#BDBDB8] hover:bg-[#F2F2F1]"
          >
            Inicio
          </Link>
        </div>
