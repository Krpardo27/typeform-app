    ...
    <div className="space-y-6 animate-pulse" aria-hidden>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 3 }).map((_, index) => (
          ...
          >
            <div className="h-4 w-28 rounded-md bg-[#E5E5E5]" />
            <div className="mt-3 h-8 w-24 rounded-md bg-[#E5E5E5]" />
      ...
      <div className="rounded-xl border border-[#E5E5E5] bg-[#FFFFFF] p-6">
        <div className="h-5 w-48 rounded-md bg-[#E5E5E5]" />
        <div className="mt-4 space-y-3">
          <div className="h-3 w-full rounded-md bg-[#F5F5F5]" />
          <div className="h-3 w-11/12 rounded-md bg-[#F5F5F5]" />
          <div className="h-3 w-9/12 rounded-md bg-[#F5F5F5]" />
        </div>
      </div>
    </div>
  );
